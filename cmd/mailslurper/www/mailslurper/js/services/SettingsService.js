...
window.SettingsService = {
    ...
    getServiceURL: function (serviceSettings) {
        ...
        var serviceAddress = serviceSettings.servicePublicAddress;
    ...
    retrieveServiceSettings: function () {
        if (localStorage["serviceSettings"]) {
            return Promise.resolve(JSON.parse(localStorage["serviceSettings"]));
        }

        return window.SettingsService.getServiceSettings().then(function (serviceSettings) {
     ...
     * from the user's local storage.
     */
    retrieveServiceSettingsSync: function () {
        return Promise.resolve(JSON.parse(localStorage["serviceSettings"]));
    },
